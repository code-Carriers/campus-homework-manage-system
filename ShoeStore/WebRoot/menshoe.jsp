		...
		<div class="grids_of_4">
		  ...
		  <div class="grid1_of_4">
				<div class="content_box">
					<a href="details.action?sid=<s:property value="#menshoe.sid"/>">
			   	  		<div class="view view-fifth">
			   	   	 		<img src="images/<s:property value="#menshoe.picture"/> " class="img-responsive" alt=""/>
				   	   		<div class="mask"><div class="info">Quick View</div></div>
				   	    </div>
				    </a>
				    <h4><a href="details.action?sid=<s:property value="#menshoe.sid"/>"> <s:property value="#menshoe.shoename"/> </a></h4>
				     <p>It is a long established fact that a reader</p>
				     <span>$<s:property value="#menshoe.price"/></span>
			   	</div>
			</div>
