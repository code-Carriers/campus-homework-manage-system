...
<div class="col-md-9 w_content">
		...
		<div class="grids_of_4">
		 	...
		 	<s:iterator value="#session.brandshoe" var="brandshoe">
		 		
		  <div class="grid1_of_4">
				<div class="content_box">
					<a href="details.action?sid=<s:property value="#brandshoe.sid"/>">
			   	  		<div class="view view-fifth">
			   	   	 		<img src="images/<s:property value="#brandshoe.picture"/> " class="img-responsive" alt=""/>
				   	   		<div class="mask"><div class="info">Quick View</div></div>
				   	    </div>
				    </a>
				    <h4><a href="details.action?sid=<s:property value="#brandshoe.sid"/>"> <s:property value="#brandshoe.shoename"/> </a></h4>
				     <p>It is a long established fact that a reader</p>
				     <span>$<s:property value="#brandshoe.price"/></span>
			   	</div>
			</div>
