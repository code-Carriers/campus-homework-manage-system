...
<body>
	...
	<div class="banner_bottom">
		<div class="container">
			<h3 class="tittle">所有新书</h3>
			<div class="inner_sec_info">
				<!-- left side -->
				<div class="col-md-8 blog_section">
					<div class="col-xs-6 blog_img blog_img-mtextmk">
						<div class="blog_con">
							<a href="single.html">
								<img src="images/mf1.jpg" alt=" " class="img-responsive">
							</a>
							<div class="blog_w3_info mmainsmk-blogsl">
								<h4>6th - Jan 2018</h4>
								<h5>
					...
					<div class="col-xs-6 blog_img blog_img-mtextmk">
						<div class="blog_con">
							<a href="single.html">
								<img src="images/mf5.jpg" alt=" " class="img-responsive">
							</a>
							<div class="blog_w3_info mmainsmk-blogsl">
								<h4>7th - Feb 2018</h4>
								<h5>
					...
					<div class="col-xs-6 blog_img blog_img-mtextmk">
						<div class="blog_con">
							<a href="single.html">
								<img src="images/mf3.jpg" alt=" " class="img-responsive">
							</a>
							<div class="blog_w3_info mmainsmk-blogsl">
								<h4>14th - Jan 2018</h4>
								<h5>
