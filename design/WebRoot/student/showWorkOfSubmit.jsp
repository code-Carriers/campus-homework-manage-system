    	...
    	<!--main content start-->
     	<section id="main-content">
     		 <section class="wrapper">
     		    <div style="font-size: 20px;padding: 20px;"> <a>作业管理</a>&nbsp;/&nbsp;<a>已交作业列表</a><br></div>
     		  <s:if test="#session.workofsubmit.size!=0">
     			<s:iterator value="#session.workofsubmit" var="work">
					...
					<div align="center" style="font-size:20px;margin: 25px;padding: 25px;">
						...
						<s:if test="#pager.hasFirst">
							<a href="showWorkOfSubmit.action?currentPage=1">首页</a>
						</s:if>
						<s:if test="#pager.hasPrevious">
							<a href="showWorkOfSubmit.action?currentPage=<s:property value="#pager.currentPage-1"/>">
							上一页
							</a>
						</s:if>
						...
						<s:if test="#pager.hasLast">
				   	 		<a href="showWorkOfSubmit.action?currentPage=<s:property value="#pager.totalPage"/>">
							尾页
							</a>
						</s:if>
					...
					<div align="center" style="padding: 150px;">
						<p style="font-style: italic;font-size: 20px;">没有已交的作业哦~</p>
						</div>
					</s:else>
     		 </section>
     	</section>
