  	...
  	<section id="container" >
    	...
    	<!--main content start-->
     	<section id="main-content">
     		 ...
     		 <div style="font-size: 20px;padding: 20px;"> <a>作业管理</a>&nbsp;/&nbsp;<a>未交作业列表</a><br></div>
     		 	 <s:if test="#session.workofnosubmit.size!=0">
     			<s:iterator value="#session.workofnosubmit" var="work">
						<div style="color:green;font-size:18">
							...
							标题：<a href="stuWorkDetail.action?workid=<s:property value="#work.workid"/>">
								<b><s:property value="#work.title"/></b>
								</a>
							<br>
							内容：<i><s:property value="#work.context"/></i>
							<br>
					...
					<div align="center" style="font-size:20px;margin: 25px;padding: 25px;">
						...
						<s:if test="#pager.hasFirst">
							<a href="showWorkOfNoSubmit.action?currentPage=1">首页</a>
						</s:if>
						<s:if test="#pager.hasPrevious">
							<a href="showWorkOfNoSubmit.action?currentPage=<s:property value="#pager.currentPage-1"/>">
							上一页
							</a>
						</s:if>
						...
						<s:if test="#pager.hasLast">
				   	 		<a href="showWorkOfNoSubmit.action?currentPage=<s:property value="#pager.totalPage"/>">
							尾页
							</a>
						</s:if>
				...
				<s:else>
					<div align="center" style="padding: 150px;">
						<p style="font-style: italic;font-size: 20px;">没要交的作业哦~</p>
					</div>
				</s:else>
     		 </section>
     	</section>
