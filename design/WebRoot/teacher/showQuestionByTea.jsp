    	...
    	<!--main content start-->
     	<section id="main-content">
     		 <section class="wrapper">
     		  <div style="margin: 10px;padding: 10px;font-size: 20px;"> <a>答疑管理</a>&nbsp;/&nbsp;<a>查看疑惑记录</a><br></div>
     			<s:if test="#session.questionbytea.size!=0">
     		 		<c:forEach items="${sessionScope.questionbytea }" var="question">
						...
						<div style="display:inline-block;width: 400px">
								...
								<c:if test="${question.answer!=null }">
									...
									<div style="background-color:silver;">
										<a>${question.teacher.name}</a>的回复：&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;5秒前<br>
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										${question.answer}
										<div>
     		 		...
     		 		<s:set value="#session.pager" id="pager"/>
						<s:if test="#pager.hasFirst">
							<a href="showQuestionByTea.action?currentPage=1">首页</a>
						</s:if>
						<s:if test="#pager.hasPrevious">
							<a href="showQuestionByTea.action?currentPage=<s:property value="#pager.currentPage-1"/>">
							上一页
							</a>
						</s:if>
						...
						<s:if test="#pager.hasLast">
				   	 		<a href="showQuestionByTea.action?currentPage=<s:property value="#pager.totalPage"/>">
							尾页
							</a>
						</s:if>
				...
				<s:else>
					    <div class="no-doc">
							...
							<p style="margin: 10px;padding: 10px;font-size: 20px;">没有疑问记录哦~</p>
						</div>
				</s:else>
     		</section>
     	</section>
