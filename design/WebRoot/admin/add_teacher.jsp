    	...
    	<!--main content start-->
     	<section id="main-content">
     		 <section class="wrapper">
     			...
     			<div align="center">
     				<a href="admin/query_teachert.jsp"><button  style="font-size: 20px;">返回</button></a>
     				<p id="message" style="color: red;"></p>
     				<form action="add_teacher_user.action" method="post" enctype="multipart/form-data">
     				<table class="admin-table">
     					<tr>
     						<td>工号</td>
     						<td><input type="text" name="teacher.number" id="number"/></td>
     					</tr>
     					<tr>
     						<td>邮箱</td>
     						<td><input type="text" name="teacher.email" id="email"/></td>
     					</tr>
     					<tr>
     						<td>密码</td>
     						<td><input type="password" name="teacher.password" id="password1"/></td>
     					</tr>
     					<tr>
     						<td>确认密码</td>
     					...
     					<tr>
     						<td>姓名</td>
     						<td><input type="text" name="teacher.name" id="name"/></td>
     					</tr>
     					<tr>
     						<td>电话</td>
     						<td><input type="text" name="teacher.telephone"/></td>
     					</tr>
     					<tr>	
     						<td>学校</td>
     						<td><input type="text" name="teacher.school"/></td>
     					</tr>
     					<tr>
     						<td>头像</td>
