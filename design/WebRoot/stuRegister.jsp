...
<html>
  ...
  <body>		
  		 <div class="journeyProgress">
            <ul>
                <li class="currentStep">注册信息</li>
                <li><i class="icon-user"></i>基本信息</li>
             	<li></li><li></li>
                <a href="stuLogin.jsp" style="color:while;font-size:20" >直接登录</a>
            </ul>
            
        </div>
		<div align="center">
  			<h1 style="color:green;font-size: 20px; "><b>学生注册页面</b></h1>
  			<h2><a href="teaRegister.jsp" style="color:black ;font-size: 16px;">教师注册</a> </h2>
  		</div>
        <div id="phizzForm" class="form">
            <form action="stuRegister.action" method="post" enctype="multipart/form-data">
                <div class="formPanel">
                    <h2>注册信息</h2>                   
                    ...
                    <fieldset>
                        ...
                        <div class="formRow">
                            ...
                            <input type="email" placeholder="Email" name="student.email" id="email">
                         ...
                         <div class="formRow">
                            ...
                            <input type="password" placeholder="Password" name="student.password" id="password">
                    ...
                    <fieldset>
                        <legend>基本信息</legend>
                         ...
                         <div class="formRow">
                            ...
                            <span class="inputAddOn"><i class="icon-user"></i></span>
                            <input type="text" placeholder="Name" name="student.name" id="name">
                            <div class="tooltip"><p>请填写真实名字，以便老师查看你的信息.</p>
                            <i class="icon-caret-down"></i></div>
                        ...
                        <div class="formRow">
                            ...
                            <input type="text" placeholder="学号" name="student.number" id="number">
                            <div class="tooltip"><p>请输入学号.</p><i class="icon-caret-down"></i></div>
                        ...
                        <div class="formRow">
                            ...
                            <input type="tel" placeholder="Phone number" name="student.telephone" id="phoneNumber">
