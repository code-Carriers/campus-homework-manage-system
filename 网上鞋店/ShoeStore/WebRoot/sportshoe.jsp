...
<div class="col-md-9 w_content">
		...
		<div class="grids_of_4">
		 	<s:iterator value="#session.sportshoe" var="sportshoe">
		 		
		  <div class="grid1_of_4">
				<div class="content_box">
					<a href="details.action?sid=<s:property value="#sportshoe.sid"/>">
			   	  		<div class="view view-fifth">
			   	   	 		<img src="images/<s:property value="#sportshoe.picture"/> " class="img-responsive" alt=""/>
				   	   		<div class="mask"><div class="info">Quick View</div></div>
				    </a>
				   	    </div>
				    <h4><a href="details.action?sid=<s:property value="#sportshoe.sid"/>"> <s:property value="#sportshoe.shoename"/> </a></h4>
				     <p>It is a long established fact that a reader</p>
				     <span>$<s:property value="#sportshoe.price"/></span>
			   	</div>
			</div>
