...
<div class="col-md-9 w_content">
		...
		<div class="grids_of_4">
		 	<s:iterator value="#session.kidshoe" var="kidshoe">
		 		
		  <div class="grid1_of_4">
				<div class="content_box">
					<a href="details.action?sid=<s:property value="#kidshoe.sid"/>">
			   	  		<div class="view view-fifth">
			   	   	 		<img src="images/<s:property value="#kidshoe.picture"/> " class="img-responsive" alt=""/>
				   	   		<div class="mask"><div class="info">Quick View</div></div>
				    </a>
				   	    </div>
				    <h4><a href="details.action?sid=<s:property value="#kidshoe.sid"/>"> <s:property value="#kidshoe.shoename"/> </a></h4>
				     <p>It is a long established fact that a reader</p>
				     <span>$<s:property value="#kidshoe.price"/></span>
			   	</div>
			</div>
